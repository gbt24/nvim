...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr,"n","<Leader>gf","<cmd>Lspsaga lsp_finder<CR>",opts)

  vim.api.nvim_buf_set_keymap(bufnr,"n","gl","<cmd>Lspsaga show_line_diagnostics<CR>",opts)

  vim.api.nvim_buf_set_keymap(bufnr,"n","gc","<cmd>Lspsaga show_cursor_diagnostics<CR>",opts)

  vim.api.nvim_buf_set_keymap(bufnr,"n","<Leader>ca","<cmd>Lspsaga code_action<CR>",opts)

  vim.api.nvim_buf_set_keymap(bufnr,"x","<Leader>ca","<cmd>Lspsaga range_code_action<CR>",opts)
