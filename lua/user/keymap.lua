...
keymap("n","sj",":set splitright<CR>:vsplit<CR>",opts)
...
-- symbols-outline
keymap("n","<Leader>v","<cmd>SymbolsOutline<CR>",opts)
...
-- 查找帮助文档
keymap("n", "<A-h>", "<cmd>Telescope help_tags<CR>", opts)
-- 查找最近打开的文件
keymap("n", "<A-o>", "<cmd>Telescope oldfiles<CR>", opts)
-- 查找 bookmarks 标记
keymap("n", "<A-m>", "<cmd>Telescope vim_bookmarks current_file<cr>", opts)
keymap("n", "<A-M>", "<cmd>Telescope vim_bookmarks all<cr>", opts)
-- 查看可用主题
...
keymap("n","<C-l>","<cmd>SessionManager load_session<cr>",opts)
