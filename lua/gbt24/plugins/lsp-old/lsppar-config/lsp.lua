...
vim.diagnostic.config({
	...
	signs = {
		text = {
			[vim.diagnostic.severity.ERROR] = icons.icons.diagnostic.error,
			[vim.diagnostic.severity.WARN] = icons.icons.diagnostic.warn,
			[vim.diagnostic.severity.INFO] = icons.icons.diagnostic.info,
			[vim.diagnostic.severity.HINT] = icons.icons.diagnostic.hint,
		},
	},
})
