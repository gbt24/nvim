...
M.Diagnostics = {
	...
	static = {
		error_icon = icons.icons.diagnostic.error,
		warn_icon = icons.icons.diagnostic.warn,
		info_icon = icons.icons.diagnostic.info,
		hint_icon = icons.icons.diagnostic.hint,
	},
